...
########################################################
    ...
    # for i in range(0, len(coded_bits)/7):
        # print "codedbits", i, coded_bits[i * 7 : i * 7 + 7]
    #print "coded_bits", numpy.reshape(coded_bits, 7)
...
#################################
    ...
    # for i in range(0, len(rcdbits)/7):
        # print "codedbits", i, rcdbits[i * 7 : i * 7 + 7]
    #print "coded_bits", numpy.reshape(rcdbits, 7)
